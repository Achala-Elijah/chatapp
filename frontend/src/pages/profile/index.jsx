                ...
                <div className="grid grid-cols-2">
                    ...
                    >
                        ...
                        </Avatar>
                        {
                            ...
                            onClick={image ? handleDeleteImage : handleFileInputClick}>{image ? <FaTrash className="text-white text-3xl cursor-pointer"/> : <FaPlus className="text-white text-3xl cursor-pointer"/>}</div>
                        }
                    ...
                    <div className="flex min-w-32 md:min-w-64 flex-col gap-5 text-white items-center justify-center">
                        ...
                        <div className="w-full flex gap-5">
                            {
                                colors.map((color, index) => <div className={`${color} h-5 w-5 sm:h-8 sm:w-8 rounded-full cursor-pointer transition-all duration-300 ${selectedColor === index ? "outline outline-white/50 outline-2" : ""}`} key={index} onClick={() => setSelectedColor(index)}></div>)
                            }
                        </div>
                    </div>
                </div>
