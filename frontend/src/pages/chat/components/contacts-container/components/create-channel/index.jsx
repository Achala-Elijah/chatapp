...
import { CREATE_CHANNEL_ROUTE, GET_ALL_CONTACTS_ROUTE, HOST, SEARCH_CONTACTS_ROUTES } from "@/utils/constants"
    ...
    <TooltipProvider>
        ...
        <Dialog open={newChannelModal} onOpenChange={setNewChannelModal}>
                <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
                    ...
                    <div>
                        <Input placeholder="Channel Name" className="rounded-lg bg-[#2c2e3b] border-none" 
