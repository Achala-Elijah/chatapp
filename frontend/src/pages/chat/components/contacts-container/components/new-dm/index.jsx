    ...
    <TooltipProvider>
        ...
        <Dialog open={openNewContactModal} onOpenChange={setOpenNewContactModal}>
                <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
                    ...
                    <div>
                        <Input placeholder="Search Contacts" className="rounded-lg bg-[#2c2e3b] border-none" 
                    ...
                    {
                        searchedContacts.length <= 0 && <div className="flex-1 md:flex mt-5 md:mt-0 flex-col justify-center items-center hidden duration-1000 transition-alld">
                        <Lottie 
